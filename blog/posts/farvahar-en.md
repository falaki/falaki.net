...
![Behistun, Darius’ relief (ca. 520 BCE)](blog/images/farvahar2.webp)

There are other examples of the symbol on rock relief. The tomb of Qyzqapan in Iraq is one example. The most accepted theory is that it belongs to a local ruler and not a Median king as Herzfeld originally hypothesized.

There are other examples of the symbol on rock relief. The tomb of Qyzqapan in Iraq is one example. The most accepted theory is that it belongs to a local ruler and not a Median king as Herzfeld originally hypothesized.
Press enter or click to view image in full size

![The rock-cut tomb of Qyzqapan in Sulaymaniyah, Iraq](blog/images/farvahar3.webp)

However, even earlier examples of nearly identical motifs are found in the remains of Assyrian architecture.

![Depiction of Asure (9th-8th BCE)](blog/images/farvahar4.webp)

Both the Assyrians and the Iranians appear to have borrowed this symbol from the Egyptian falcon-god [Horus](https://en.wikipedia.org/wiki/Horus). The winged sun disk represented divine kingship and protection in Egypt. In Assyria, the winged sun disk was a prominent symbol of Ashur, who also embodied divine power and the king’s connection to the divine.
