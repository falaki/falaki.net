...
### پروکلسیتونین
* کووید۱۹ ظاهرا باعث افزایش پروکلسیتونین نمیشود. به عنوان مثال بزرگترین تحقیقات نشان داد که سطح پروکلسیتونین در ۹۵٪ بیماران زیر ۰.۵ بود ([Guan et al 2/28](Guan et al 2/28)).
...
*   اطلاعات فراهم شدهی زیر راه های درمانی محبوبی هستند که که توسط بعضی پزشکان استفاده میشود.
     ...
     * اگر شما هم اطلاعاتی درباره شواهد کارکرد داروهای ضد ویروسی دارید لطفا در وب پیج کووید ۱۹ ((https://emcrit.org/pulmcrit/covid19/) [اینجا]) با ما به اشتراک بگذارید.
...
([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long))
...
* دستورالعمل های ([WHO شواهد مربوط به استروئید را خلاصه می کند. برای اطلاعات بیشتر اینجا را مطالعه کنید ((file:///Users/joshuafarkas1/Downloads/clinical-management-of-novel-cov%20(1).pdf)[آخر صفحه 4)



## اسید اسکوربیک؟

* به نظر می آید اسید اسکوربیک باعث بهبود مرگ و میر با توجه به نتایج  آزمایش ([CITRIS-ALI](https://jamanetwork.com/journals/jama/article-abstract/2752063)) در چند مرکز می شود. با این وجود برداشت های انجام شده از نتایج این آزمایش به شکل نا امید کننده ای ((https://emcrit.org/pulmcrit/pulmcrit-citris-ali-can-a-secondary-endpoint-stage-a-coup-detat/)[بحث برانگیز]) بوده چرا که پیچیدگی های غیرقابل حلی در ارتباظ با تمایل برای بقا (survival-ship bias) وجود دارد.
