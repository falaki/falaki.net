کتابچه مراقبتهای ویژه برای کووید۱۹
...
* کووید ۱۹ یکی از اعضای خانواده کورونا ویروس ها است. این ویروسها شامل
    * چهار ویروس بسیار رایج که منشا سرماخوردگی عادی هستند (اما ممکن است در بیماران همراه با  بیماریهای زمینه ای منجر به پنومونی ویروسی شود).
...
![](images/image15.png)
## نامگذاری به کار رفته در این کتابچه

* از نظر تکنیکی ویروس  “SARS-CoV-19” و بیماری کلینیکی “COVID-19” نامیده میشود که کمی گیج کننده است. به همین دلیل در این مبحث از واژه COVID-19 برای هر دو مورد استفاده میشود.
* واژه سارس (SARS) نیز اشاره به ویروس سارس ۲۰۰۳ دارد (که اخیرا SARS-CoV-1 نامگذاری شده است).
...
* به نظر میرسد بیماری مراحل مختلفی دارد که بیماران در طول بیماری طی میکنند:
     ...
     * مرحله دوم (دوره ایمنی تطبیقی ): در نهایت ایمنی تطبیقی نسبت به ویروس شروع میشود. در پی این مرحله تیتر ویروس کاهش پیدا میکند. از طرفی این مرحله ممکن است به افزایش سایتوکینهای التهابی و در نتیجه آسیب بافتی بیانجامد -- که منجر به وخامت وضعیت بالینی میشود.
...
* نکات فوق پیامدهای بالینی مهمی دارد:
     * از روی علائم بالینی اولیه نمیتوان شدت بیماری در مرحله دوم را پیش بینی کرد. روشهای پیچیدهای برای طبقه بندی بیماران از نظر ریسک و تغییروضعیت (دیسپوزیشن) نیاز است.
...
## انتقال از طریق ریز قطرات airborne transmission

* در حال حاضر در مورد اینکه ایا کووید۱۹ می تواند توسط ریز قطرات هم انتقال یابد جای بحث وجود دارد (ذرات ریزتر مدت زمان بیشتری در هوا باقی می مانند). در صورتی که روش انتقال ویروس از طریق ریز قطرات  صحت داشته باشد به جای استفاده از ماسک استاندارد جراحی احتیاج به استفاده از ماسک  N95 یا FPP2 است. ادامه این بحث را اینجا میتوانید دنبال کنید [Shiu et al 2019](https://emcrit.org/wp-content/uploads/2020/03/tada2019.pdf).
* تمهیدات پیشگیرانه سختگیرانهای برای جلوگیری  از انتقال ویروس از طریق ریز قطرات در مرس (MERS) و سارس (SARS) بر مبنای احتیاط اتخاذ شده است. این در حالی است که این تمهیدات بر پایه شواهد علمی واضح بر اساس انتقال از طریق ترشحات معلق در هوا نبوده است. با این حال همین ملاحظات پیشگیرانه برای جلوگیری از انتقال هوایی کووید۱۹ دنبال می شود.
* دستورالعمل ها برای جلوگیری از انتقال ویروس متفاوت است:
     * [دستورالعمل های کانادا](https://www.canada.ca/en/public-health/services/diseases/2019-novel-coronavirus-infection/health-professionals.html) و [سازمان بهداشت جهانی](https://www-who-int.ezproxy.uvm.edu/publications-detail/infection-prevention-and-control-during-health-care-when-novel-coronavirus-(ncov)-infection-is-suspected-20200125) تنها استفاده از تمهیدات پیشگیرانه برای جلوگیری از انتشار  ویروس از طریق قطرات درشت را در زمان مراقبت های روتین بیمار پیشنهاد می دهند. اگر چه هر دوی این دستور العمل ها استفاده از تمهیدات پیشگیرانه  برای جلوگیری از انتشار ویروس از طریق ریز قطرات در مواردی مانند  اینتوبه کردن ,noninvasive ventilation, سی پی آر وbag-mask ventilation و برونکوسکوپی را لازم میدانند.
     * مرکز کنترل و پیشگیری بیماری های ایالات متحده آمریکا (CDC) [استفاده از تمهیدات پیشگیرانه](https://www-cdc-gov.ezproxy.uvm.edu/coronavirus/2019-ncov/infection-control/control-recommendations.html?CDC_AA_refVal=https%3A%2F%2Fwww.cdc.gov%2Fcoronavirus%2F2019-ncov%2Fhcp%2Finfection-control.html) برای جلوگیری از انتقال ویروس  از طریق ریزقطرات را را در تمام موارد نگهداری و مدیریت بیمار الزامی می داند.
* استفاده از تمهیدات  لازم برای جلوگیری از انتقال ویروس از طریق ریزقطرات در تمام بیماران باعث کمبود سریع ماسک های N95 شده و این روند باعث میشود کادر درمانی در هنگام انجام روند های تشخیصی و درمانی در معرض خطر قرار بگیرند.
...
* هر نوع تلاشی بر جلوگیری از گسترش ویروس باید توجه ویژه ای به انتقال نوع تماسی داشته باشد. چرخه انتقال ویروس به روش بالا به راه های گوناگونی قابل جلوگیری است:
     * تمیزکردن مرتب سطوح با اتانول ۷۰٪ و محلول ۰.۵٪ سدیم هایپوکلورایت  sodium hypochlorite یا به عبارتی وایتکس یا آب ژاول. برای جزئیات بیشتر به [دستورالعمل های مرکز کنترل و پیشگیری بیماری های ایالات متحده آمریکا](https://www-cdc-gov.ezproxy.uvm.edu/coronavirus/2019-ncov/infection-control/control-recommendations.html?CDC_AA_refVal=https%3A%2F%2Fwww.cdc.gov%2Fcoronavirus%2F2019-ncov%2Fhcp%2Finfection-control.html)  و  مقاله  [Kampf et al 2020](https://emcrit.org/wp-content/uploads/2020/02/10.1016@j.jhin_.2020.01.022-2.pdf) مراجعه شود.
...
* مشخصترین یافته موجود در عکسها نقاط شفاف پراکنده است که که عموما  پایین یا اطراف قفسه سینه دیده میشوند ([Shi et al 2/24](https://www.thelancet.com/action/showPdf?pii=S1473-3099%2820%2930086-4)). تعداد قطعات درگیر شش با افزایش شدت بیماری افزایش پیدا میکند. با گذر زمان، نقاط پراکنده شفاف متصل شده به توده چگال تبدیل میشوند.
* ضایعات در عکس رادیولوژی به راحتی قابل مشاهده نیستند.([ Silverstein et al](https://www.thelancet.com/action/showPdf?pii=S0140-6736%2820%2930370-6))
* مواردی که معمولا دیده نمیشوند و میتوانند نشانه بیماریهای دیگر یا همزمان باشند
    ...
    * کووید۱۹ به نظر نمیرسد باعث توده، حفره یا تغییر اندازه غدد لنفاوی نمیشود
...
* نتیجهگیری
     ...
     *  ([Bouadma et al.](https://link.springer.com/content/pdf/10.1007/s00134-020-05967-x.pdf))برای تشخیص کووید۱۹ نباید از برونکوسکوپی استفاده کرد.
...
* چه کسی؟
     ...
     *  فاکتورهای پیش بینی نتایج بد می تواند به ما کمک کند و نشان دهد که چه بیماری بد حال می شود و در نتیجه چه کسی از داروهای ضد ویروسی منفعت میبرد. ( به قسمت پیش بینی بیماری ([prognosis](https://emcrit.org/ibcc/COVID19/#prognosis)) در پایین مراجعه شود.


# رمدیسیویر Remdesivir  


* بر اساس تحقیقات آزمایشگاهی برروی MERS و داده های بررسی شده بر روی حیوانات Remdesivir ممکن است بهترین ضد ویروس در این مورد باشد([ Sheahan 2020](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6954302/pdf/41467_2019_Article_13940.pdf)).  
* متاسفانه Remdesivir دارویی تجاری و قابل دسترس نمی باشد.این دارو قبل از دریافت مجوز سازمان غذا و دارو آمریکا (FDA ) بر روی یک بیمار کووید ۱۹ که شرایط بحرانی داشته است در آمریکا استفاده شده است([Holshue 2020](https://www.nejm.org/doi/full/10.1056/NEJMoa2001191)).
* این دارو (Remdesivir) به شکل آزمایشی ([one trial](https://clinicaltrials.gov/ct2/show/NCT04280705)) با پشتیبانی NIAID در ایالات متحده آمریکا در حال استفاده می باشد. ثبت نام در این آزمایش می تواند برای درمان های ویروسی نوید بخش باشد.
...
* داروهای lopinavir/ritonavir به نظر میاید که به طور همزمان با ribavirin کار می کند. داده های انسانی بر روی SARS و MERS حکایت از ترکیب این سه دارو دارد. ممکن است ترکیبی از این سه دارو برای تاثیر بهتر بر روند بهبود لازم باشند (احتمال کار نکردن این داروها به شکل تکی وجود دارد). یک تحقیق کوچک بر روی lopinavir/ritonavir نشان داد که درمان سه گانه با lopinavir/ritonavir/ribavirin ممکن است لازم باشد ([Young 3/3/20](https://jamanetwork.com/journals/jama/fullarticle/2762688)).
...
*  اوج و حضیض سرم متمرکز lopinavir   و ۵.۵ و۱۰ ug/ml است ([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long)).

## داده های جانوری

* داروهای lopinavir و ritonavir  بر روی MERS-CoV در مدل های حیوانی دسته میمون ها تاثیر گذار بودند([Chan 2015](https://www.ncbi.nlm.nih.gov/pubmed/26198719)).
...
* مطالعه ([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long)) مقایسه ای open-labee (بیماران و درمانگران هر دو درباره نوع ومراحل درمان آگاهی دارند): بر روی سارس:
...
* مطالعه دیگری که شامل بازنگری و بررسی مطالعات قبلی (retrospective cohort study )برروی SARS بوده است به نتایج زیر رسیده است ([Chan et al. 2003](https://thorax.bmj.com/content/59/3/252.long)):
...
* در این ([Park et al. 2019](https://www.ncbi.nlm.nih.gov/pubmed/30240813)) مطالعه که شامل بازنگری و بررسی مطالعات  گروهی قبلی بوده (retrospective cohort study ) برروی اقدامات پیشگیرانه بعد از در معرض عوامل بیماری زا بر علیه MERS نتایج زیر قابل توجه است.
...
* ([Young et al. 3/3/2020](https://jamanetwork.com/journals/jama/fullarticle/2762688))
...
* شواهد دیگری برای کیفیت کمتر:
     * دارو lopinavir/ritonavir برای درمان یک بیمار مبتلا به کووید ۱۹ استفاده شده است ([Kim 2020](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7025910/pdf/jkms-35-e79.pdf)).
     * درمان با lopinavir/ritonavir فقط در بعضی موارد مرس تاثیر گذار گزارش شده است ([Momattin 2019](https://www.ncbi.nlm.nih.gov/pubmed/31252170)).
...
### دوز دارو 
* لوپیناویر/رینتوناویر (Lopinavir/Ritonavir) برای اطلاعات بیشتر به اینجا ([Monograph](https://reference.medscape.com/drug/kaletra-lopinavir-ritonavir-342629)) مراجعه شود.
    ...
    * خرد کردن و دادن قرص ها به بیمار از طریق لوله معده جذب دارو را تا حدود ۵۰٪ ممکن است کم کند. زیاد کردن دوز دارو ممکن است در چنین شرایطی لحاظ شود ([Best et al. 2011](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3205189/)).
* ریباویرین Ribavirin برای اطلاعات بیشتر به اینجا ([Monograph](https://reference.medscape.com/drug/rebetol-ribasphere-ribavirin-342625)) مراجعه شود. 
    * مشخص نیست که آیا استفاده همزمان از ریباویرین مفید باشد. 
    * بهترین رژیم دارویی مورد تایید  ([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long)) احتمالا مصرف خوراکی ۲ بار در روز دارو است. دوز اول  ۴ گرم و برای دوز بعدی ۱.۲ گرم هر ۸ ساعت ( یا ۸ میلی گرم/kg هر ۸ ساعت IV) برای ۱۴ روز. 

### عوارض و ملاحظات در صورت مصرف لوپیناویر/رینتوناویر
...
تحمل پذیری کلی
    * ر مطالعه  ([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long)) چهل و یک بیمار مبتلا به سارس توانستند لوپیناویر/رینتوناویر (Lopinavir/Ritonavir) را بدون مشکل مصرف کنند (فقط یک بیمار به خاطر بالا رفتن سطح ترانس آمینازمجبور به قطع دارو شد).
    * در مطالعه ([Chan 2003](https://www.hkmj.org/abstracts/v9n6/399.htm)) هفتاد و پنج بیمار سارس با  لوپیناویر/رینتوناویر (Lopinavir/Ritonavir) درمان شدند بدون اینکه با عوارض دارویی مواجه شوند.
* اطلاعات بیشتر
    * این مطالعه ([PulmCrit blog 3/4](https://emcrit.org/pulmcrit/lopinavir/)) درباره تحقیق یانگ و درمان دو دارویی یا سه دارویی اطلاعات بیشتری ارائه می دهد.
    * اطلاعات بیشتر در این مورد را می توانید در این مقاله ([Yao TT et al](https://onlinelibrary.wiley.com/doi/epdf/10.1002/jmv.25729)) دنبال کنید. 
...
* نتایج آزمایشگاهی با استفاده از cell lines نشان میدهد که کلوروکویین میتواند کووید۱۹ را با تمرکز inhibitory ۵۰٪ از ۱ uM متوقف کند که به نظر میرسد میتواند برای انسانها خواص درمانی داشته باشد  ([Wang 2020](https://www.ncbi.nlm.nih.gov/pubmed/32020029)). این عدرد برای ویروس سارس نزدیک به ۹ uM که نشان میدهد کلوروکویین میتواند بر علیه کووید۱۹ اثرگذارتر از سارس باشد.

## داده های حیوانی

*  ([Bernard 2006](https://www.ncbi.nlm.nih.gov/pubmed/17176632))کلوروکویین نتوانست موشهای آلوده به سارس را درمان کند

## داده های انسانی

* دادههای اولیه از چین نشان میدهد کلوروکویین نتایج مثبتی داشته اما دادههای دقیق هنوز در دسترس نیست  ([Gao 2020](https://www.jstage.jst.go.jp/article/bst/advpub/0/advpub_2020.01047/_pdf/-char/en)). توافق متخصصین چینی این است که رژیم ۵۰۰ میلیگرم دو بار در روز برای بیماران بدون contraindications تجویز شود (Zhi 2020). امیدواریم نتایج بالینی به زودی منتشر شوند.

#  ([Monograph](https://reference.medscape.com/drug/aralen-chloroquine-phosphate-chloroquine-342687))دوز تجویزی

* ۵۰۰ میلیگرم فسفات کلوروکویین حاوی ۳۰۰ میلیگرم کلروکویین است
* ۵۰۰ میلیگرم خوراکی دو بار در روز برای ۱۰ رژیم توصیهشده توسط گروهی در چین بود که به بیماران بدون عوارض جانبی ([Zhi 2020](https://www.ncbi.nlm.nih.gov/pubmed/32075365)).
...
* اطلاعات متناقضی از چین در مورد میزان گستردگی استفاده از این دارو رسیده است.
     ...
     * بعضی مقالات موکدا آن را توصیه میکنند  ([Zhi 2020](https://www.ncbi.nlm.nih.gov/pubmed/32075365)), ([Gao 2020](https://www.jstage.jst.go.jp/article/bst/advpub/0/advpub_2020.01047/_pdf/-char/en))
...
* امیدواریم به زودی اطلاعات بیشتری در دسترس قرار گیرد.([Roques et al 2018](https://www.ncbi.nlm.nih.gov/pubmed/29772762))

# اوسلتاماویر و سایر بلاککننده های نورومینیداس


* ([Tan et al 2004](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3323075/pdf/03-0458.pdf))به نظر میرسد بلاککننده های نورومینیداس بر کووید۱۹ اثرگذار نیستند
...
* ذات الریه باکتریایی می تواند در دوران بیمارستان پدیدار شود. (به خصوص ذات الریه مرتبط با ونتیلاتور در بیمارانی که لوله گذاری شده اند).
     * در میان بیمارانی که از کووید 19 فوت شده اند یک سری نشان داده اند که 11.68 (16 درصد) عفونت ثانویه داشته اند. ([Ruran 3.3.20](https://link.springer.com/content/pdf/10.1007/s00134-020-05991-x.pdf))
* این ممکن است مشابه سایر ذات الریه های مرتبط با ونتیلاتور یا ذات الریه ناشی از بیمارستان مورد بررسی و درمان قرار گیرد.


## استروئید

* به طور کلی نباید از استروئید استفاده شود. استروئید در اپیدمی های قبلی سارس یا مرس هم فایده ای نداشته است. استروئید ممکن است باعث افزایش ریزش ویروسی گردد. ([Lee 2004](https://www.sciencedirect.com/science/article/pii/S1386653204001957?via%3Dihub))
* تقریبا تمام مقالات عدم استفاده از استروئید را توصیه می کنند. با این حال اگر نشانه واضح دیگری برای استروئید وجود داشته باشد، ممکن است از استروئید استفاده شود. (به عنوان مثال ویروس کرونا به علاوه تشدید آسم، شک سپتیک مقاوم)
      * دستورالعمل های سازمان بهداشت جهانی شواهد مربوط به استروئید را خلاصه میکند. برای اطلاعات بیشتر با [اینجا](file:///Users/joshuafarkas1/Downloads/clinical-management-of-novel-cov%20(1).pdf) مراجعه کنید (انتهای صفحه ۴ را ببینید)



## اسید اسکوربیک؟

* به نظر می آید اسید اسکوربیک باعث بهبود مرگ و میر با توجه به نتایج  آزمایش [CITRIS-ALI](https://jamanetwork.com/journals/jama/article-abstract/2752063) در چند مرکز می شود. با این وجود برداشت های انجام شده از نتایج این آزمایش به شکل نا امید کننده ای [بحث برانگیز](https://emcrit.org/pulmcrit/pulmcrit-citris-ali-can-a-secondary-endpoint-stage-a-coup-detat/) بوده چرا که پیچیدگی های غیرقابل حلی در ارتباط با تمایل برای بقا (survival-ship bias) وجود دارد.
* شواهد بسیار محدود نشان می دهد که اسید اسکوربیک می تواند در مدل های حیوانی ویروس کرونا مفید باشد. (َ[Atherton 1987](https://www.ncbi.nlm.nih.gov/pubmed/205194))
...
۲. ([Guan et al 2/28](https://www.nejm.org/doi/pdf/10.1056/NEJMoa2002032?articleTools=true))در میان بیماران بستری شده
...
۳. پیامدهای بلند مدت: وابستگی طولانی مدت به تنفس مصنوعی؟
      * بیمارانی که از مرحله ابتدایی نجات می یابند نیاز طولانی مدت به دستگاه تنفس مصنوعی دارند (احتمالا المان هایی از فیبروز ریوی را بروز می دهند). ([Zhang 2020](https://link.springer.com/article/10.1007/s00134-020-05990-y))
...
##([Zhou et al. 3/9/20](https://www.thelancet.com/action/showPdf?pii=S0140-6736%2820%2930566-3))) عوامل خطرساز اپیدمیولوژیک
* فاکتورهای ریسک:
      * کهولت سن
      * بیماری عروق کرونر
      * فشار خون
...
* بیشترین تعداد مرگ و میر توسط ((http://weekly.chinacdc.cn/en/article/id/e53946e2-c6c4-41e9-9a9b-fea8db1a8f51)[مرکز کنترل بیماری های چین]) اعلام شده است (جدول زیر). به دلیل اینکه برخی موارد بیماری ثبت نشده است، آمار دقیق مرگ و میر ممکن است متغیر باشد، اما اثر نسبی عوامل خطرساز مختلف احتمالا دقیق است.

![](images/mortdata.jpg)

## دسته بندی خطرات آزمایشگاهی
...
References: ([Ruan 3/3/20](https://link.springer.com/article/10.1007/s00134-020-05991-x)), ([Xie et al. 2020](https://link.springer.com/article/10.1007/s00134-020-05979-7)), ([Wang et al. 2/7/20.](https://jamanetwork.com/journals/jama/fullarticle/2761044)), ([Zhou et al. 3/9/20](https://www.thelancet.com/action/showPdf?pii=S0140-6736%2820%2930566-3)), ([Chu et al. 2004](https://thorax.bmj.com/content/59/3/252.long)),  ([Liu et al. pre-print](https://www.medrxiv.org/content/10.1101/2020.02.10.20021584v1.full.pdf))


![](images/zhoupx-scaled.jpg)

![](images/ruancovid.jpg)

![](images/wangjamapx.jpg)
